...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-site mx-auto px-6 h-[72px] flex items-center justify-between overflow-hidden">
        <a href="#home" className="flex items-center gap-3" aria-label={siteConfig.firmName}>
          <img
      ...
      >
        <div className="flex items-center justify-between px-6 h-[72px]">
          <a
            ...
            onClick={closeMobile}
            aria-label={siteConfig.firmName}
          >
            <img
              src="/images/pshah-logo.png"
              alt=""
